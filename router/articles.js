...
router.post("/", async function(req, res){                                  //  POST //
    const body = req.body;
...
router.get("/:id", async function(req, res){                             // GET (ID)   //
...
router.delete("/:id", async function(req, res){                                // DELETE //
    const id = req.params.id ;
...
router.put("/:id", async function(req,res){                                       // PUT //
